...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "AcademiaDoZe.Presentation.AppMaui.dll" comes first in this list. */
		"AcademiaDoZe.Presentation.AppMaui.dll",
		"Azure.Core.dll",
		"Azure.Identity.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"AcademiaDoZe.Application.dll",
		"AcademiaDoZe.Domain.dll",
		"AcademiaDoZe.Infrastructure.dll",
